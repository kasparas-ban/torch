    ...
    data && (
      ...
      >
        <div className="mx-auto">
          ...
          <div className="mx-4 grid grid-cols-[400px_120px_100px] text-gray-500 max-[700px]:grid-cols-[240px_100px_100px] max-[500px]:grid-cols-[auto_auto_auto] max-[500px]:gap-x-3">
